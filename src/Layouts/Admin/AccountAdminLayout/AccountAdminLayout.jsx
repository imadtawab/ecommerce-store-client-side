...
export default function AccountAdminLayout() {
  return (
    <div className='AccountAdminLayout'>
        ...
        >
            ...
            <ul className="navbar">
                <li>
                    <NavLink to="/admin/account/register">Register</NavLink>
                </li>
                <li>
                    <NavLink to="/admin/account/login">Login</NavLink>
                </li>
            </ul>
        </div>
